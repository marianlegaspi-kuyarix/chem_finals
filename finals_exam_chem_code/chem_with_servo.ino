...
#define blueLEDPin 4   // Blue LED connected to pin 4 for low CO2
...
void loop() {
  ...
  if (co2ppm > highThreshold) {
    ...
    digitalWrite(blueLEDPin, HIGH);  // Turn on blue LED for low CO2
    ...
    digitalWrite(blueLEDPin, LOW);  // Ensure blue LED is off
  }
}